...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'terms'                 => 'شرایط',
        'province'              => 'استان',
        'classicaleducation'    => 'تحصیلات کلاسیک',
        'militaryeducation'     => 'تحصیلات نظامی',
        'child'                 => 'فرزند',
        'kindofmembership'      => 'عضویت',
        'personalId'            => 'شناسه',
        'presentstatus'         => 'وضعیت',
        'department'            => 'قسمت',
        'degree'                => 'درجه',
        'Responsibility'        => 'مسئولیت',
        'registeryDate'         => 'تاریخ ورود واحد',
        'entryDate'             => 'تاریخ عضویت',
        'yearsService'          => 'سال عضویت',
        'healthy'               => 'وضعیت جسمانی',
        'blood'                 => 'گروه خونی',
        'height'                => 'قد',
        'wieght'                => 'وزن',
        'bmi'                   => 'توده بدنی',
        'numberBmi'             => 'محاسبه توده بدنی',
        'Extraweight'           => 'مقدار اضافه وزن',
        'city'                  => 'شهر',
        'state'                 => 'استان',
        'codemali '             => 'کدملی',
        'shanaseh '             => 'شناسه',
